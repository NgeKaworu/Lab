...
class MainActivity : AppCompatActivity() {
    ...
    private fun captureVideo() {
        ...
        var file = File.createTempFile(name, ".mp4", this.externalCacheDir);
        Log.i(TAG, "captureVideo: ${file.absoluteFile}")
        val fileOutputOptions = FileOutputOptions.Builder(file).build();

        recording = videoCapture.output.prepareRecording(this, fileOutputOptions).apply {
    ...
    companion object {
        private const val TAG = "CameraXAppTag"
